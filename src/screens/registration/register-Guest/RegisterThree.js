...
const RegisterThree =   ({navigation}) => {
  ...
  const countries = ["One City Center1"]
...
>
  ...
  <View style={{padding:30, margin:20,borderRadius:10, backgroundColor:'white', alignItems:'center', justifyContent:'center'}}>
<TouchableOpacity 
onPress={()=> {settermscondition(false)}}
style={{alignSelf:'flex-end'}}>

<MaterialCommunityIcons color='red' name='close-circle-outline' size={40} style={{alignSelf:'center'}} />
...
under your account and accept all risks of unauthorized
</Text>
...
>
<View style={{padding:30,borderRadius:10, margin:20, backgroundColor:'white', alignItems:'center', justifyContent:'center'}}>
<TouchableOpacity 
...
such as the Personal Data Protection Committee.
</Text>
...
<Text style={styles.chkTxt}>I agree to the Privacy Policy*</Text>
</TouchableOpacity>
