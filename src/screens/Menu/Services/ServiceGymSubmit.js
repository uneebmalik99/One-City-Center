...
const ServiceGymSubmit = ({navigation}) => {
    ...
    return (
        <Tabs   colorScheme="orange" isFitted align="center" size="md" my={1}>
          ...
          <Tabs.Views>
            <Tabs.View >
              <View style={styles.cardView}>
                  <Text style={styles.submitText}>Thank you, we appreciate you taking
                  the time to report a problem. We have received your message and will look 
                  into the matter soonest.</Text>

                  <Text style={styles.submitText}>You can also check on the status of
                  your submission in the "Submtted issues" page </Text>
              </View>
            </Tabs.View>
            <Tabs.View>
            {/* <FlatList
...
export default ServiceGymSubmit;
